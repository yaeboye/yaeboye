...
<p align="left">
  <img src="https://skillicons.dev/icons?i=ts,js,python,perl,react,astro,tailwind,bun,nodejs&theme=dark" />
  <br/>
  <img src="https://skillicons.dev/icons?i=cloudflare,sqlite,githubactions,docker,git,github,vscode,linux&theme=dark" />
</p>
...
**[✍️ docsign](https://github.com/yaeboye/docsign)**<br/>
Document signing system with BLAKE2-M + ECDSA P-256 written from scratch. It ties the document, its context, the hardware and a password into one signature.<br/>
`Perl` `Cryptography`
